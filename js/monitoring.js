...
// Global variable data sistem
let dbSistem = [];
let barChartInstance = null;
let donutChartInstance = null;

// Fungsi helper universal untuk menarik data dari Cloud
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Jika sedang di halaman dashboard.html
  if (document.getElementById("tabel-tracking")) {
    window.renderTabelTracking();
  } 
  // Jika sedang di halaman monitoring.html
  else if (document.getElementById("barChart") || document.getElementById("donutChart")) {
    renderCharts();
  }
});
